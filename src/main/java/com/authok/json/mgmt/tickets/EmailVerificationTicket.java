...
/**
 * Class that represents an Authok Email Verification Ticket object. Related to the {@link TicketsEntity} entity.
 */
...
public class EmailVerificationTicket {
    ...
    /**
     * The ticket's lifetime in seconds starting from the moment of creation. After expiration the ticket can not be used to verify the users's email. If not specified or if you send 0 the Authok default lifetime will be applied.
     *
     ...
     *
     * @see <a href="https://authok.com/docs/universal-login/configure-default-login-routes#completing-the-password-reset-flow">Configuring Default Login Routes</a>
     */
    @JsonProperty("client_id")
