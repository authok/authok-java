...
/**
 * Class that represents an Authok User object. Related to the {@link UsersEntity} entity.
 */
...
public class User implements Serializable {
     ...
     * i.e. For "authok" connection with user id "123456789" the final user id would be "authok|123456789".
     *
    ...
    /**
     * Setter for the Authok Application's client ID. Only useful when updating the email.
     *
