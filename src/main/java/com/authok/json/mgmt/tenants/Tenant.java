...
import com.authok.client.mgmt.TenantsEntity;
...
/**
 * Class that represents an Authok Tenant Settings object. Related to the {@link TenantsEntity} entity.
 */
...
public class Tenant {
    ...
    /**
     * Getter for the tenant list of URLs that are valid to redirect to after logout from Authok.
     *
    ...
    /**
     * Setter for the tenant list of URLs that are valid to redirect to after logout from Authok.
     *
