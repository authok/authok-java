...
/**
 * Class that represents an Authok Application object. Related to the {@link ClientsEntity} entity.
 */
...
public class Client {
    ...
    /**
     * Setter for the application's client secret. If no secret is provided, it will be generated by the Authok Server upon Application creation.
     *
    ...
    /**
     * Getter for the application list of URLs that are valid to redirect to after logout from Authok.
     *
    ...
    /**
     * Setter for the application list of URLs that are valid to redirect to after logout from Authok.
     *
    ...
    /**
     * Whether to use Authok instead of the Identity Provider to do Single Sign On or not.
     *
     * @return true if this application will use Authok for SSO instead of the Identity Provider or not.
     */
    @JsonProperty("sso")
    ...
    /**
     * Sets if Authok will do Single Sign On instead of the Identity Provider.
     *
     * @param useAuthokSSO whether to use Authok instead of the Identity Provider to do Single Sign On or not.
     */
    @JsonProperty("sso")
    public void setUseAuthokSSO(Boolean useAuthokSSO) {
        this.sso = useAuthokSSO;
    }
    ...
    /**
     * Getter for the addons or plugins associated with an application in Authok.
     *
    ...
    /**
     * Setter for the addons or plugins associated with an application in Authok.
     *
