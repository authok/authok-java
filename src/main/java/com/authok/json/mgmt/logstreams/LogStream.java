package com.authok.json.mgmt.logstreams;

import com.authok.client.mgmt.LogStreamsEntity;
import com.fasterxml.jackson.annotation.*;

import java.util.Map;

/**
 * Represents an Authok Log Stream object. Related to the {@linkplain LogStreamsEntity}
 */
