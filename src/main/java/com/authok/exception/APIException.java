...
/**
 * Represents an Authok Server error captured from an HTTP response. Provides different methods to determine why the request failed.
 * i.e.:
 * <pre>
 * {@code
 * {
...
public class APIException extends AuthokException {
