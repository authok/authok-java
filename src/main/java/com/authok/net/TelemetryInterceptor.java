...
/**
 * OkHttp Interceptor implementation that adds the authok-client header
...
public class TelemetryInterceptor implements Interceptor {
    ...
    public TelemetryInterceptor() {
        this(new Telemetry("authok-java", Telemetry.class.getPackage().getImplementationVersion()));
    }
