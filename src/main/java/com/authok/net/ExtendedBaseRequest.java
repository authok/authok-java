...
/**
 * A request class that is able to interact fluently with the Authok server.
...
abstract class ExtendedBaseRequest<T> extends BaseRequest<T> {
    ...
    protected Request createRequest() throws AuthokException {
        ...
        try {
            ...
            throw new AuthokException("Couldn't create the request body.", e);
        }
    ...
    @Override
    protected T parseResponse(Response response) throws AuthokException {
     ...
     */
    protected AuthokException createResponseException(Response response) {
