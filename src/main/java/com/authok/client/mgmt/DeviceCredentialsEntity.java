...
/**
 * Class that provides an implementation of the Device Credentials methods of the Management API as defined in https://authok.cn/docs/api/management/v1#!/Device_Credentials
 * <p>
...
public class DeviceCredentialsEntity extends BaseManagementEntity {
     ...
     * See https://authok.cn/docs/api/management/v1#!/Device_Credentials/get_device_credentials
     *
    ...
    public Request<List<DeviceCredentials>> list(DeviceCredentialsFilter filter) {
        HttpUrl.Builder builder = baseUrl
                .newBuilder()
                .addPathSegments("api/v1/device-credentials");
        if (filter != null) {
     ...
     * See https://authok.cn/docs/api/management/v1#!/Device_Credentials/post_device_credentials
     *
