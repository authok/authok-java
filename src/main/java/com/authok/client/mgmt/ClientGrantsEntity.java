...
import com.authok.client.mgmt.filter.ClientGrantsFilter;
import com.authok.json.mgmt.ClientGrant;
import com.authok.json.mgmt.ClientGrantsPage;
...
/**
 * Class that provides an implementation of the Client Grants methods of the Management API as defined in https://authok.cn/docs/api/management/v1#!/Client_Grants
 * <p>
...
public class ClientGrantsEntity extends BaseManagementEntity {
     ...
     * See https://authok.cn/docs/api/management/v1#!/Client_Grants/get_client_grants
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Client_Grants/post_client_grants
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Client_Grants/delete_client_grants_by_id
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Client_Grants/patch_client_grants_by_id
     *
     * @param clientGrantId the client grant id.
     * @param scope         the scope to grant.
     * @return a Request to execute.
