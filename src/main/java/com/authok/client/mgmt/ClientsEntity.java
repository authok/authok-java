...
/**
 * Class that provides an implementation of the Application methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Clients
 * <p>
...
public class ClientsEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/Clients/get_clients
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Clients/get_clients_by_id
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Clients/post_clients
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Clients/delete_clients_by_id
     *
     * @param clientId the application's client id.
     * @return a Request to execute.
     */
     ...
     * See https://authok.com/docs/api/management/v2#!/Clients/patch_clients_by_id
     *
     * @param clientId the application's client id.
     * @param client   the application data to set.
     * @return a Request to execute.
     ...
     * See https://authok.com/docs/api/management/v2#!/Clients/post_rotate_secret
     *
     * @param clientId the application's client id.
     * @return a Request to execute.
     */
