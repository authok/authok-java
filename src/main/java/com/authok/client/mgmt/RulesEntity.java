...
import com.authok.client.mgmt.filter.RulesFilter;
import com.authok.json.mgmt.Rule;
import com.authok.json.mgmt.RulesPage;
...
/**
 * Class that provides an implementation of the Rules methods of the Management API as defined in https://authok.cn/docs/api/management/v1#!/Rules
 * <p>
...
public class RulesEntity extends BaseManagementEntity {
     ...
     * See https://authok.cn/docs/api/management/v1#!/Rules/get_rules
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Rules/get_rules_by_id
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Rules/post_rules
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Rules/delete_rules_by_id
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Rules/patch_rules_by_id
     *
     * @param ruleId the rule id
