...
import com.authok.json.mgmt.RulesConfig;
...
/**
 * Class that provides an implementation of the Rules Configs methods of the Management API as defined in See https://authok.com/docs/api/management/v2#!/Rules_Configs/
 * <p>
...
public class RulesConfigsEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/Rules_Configs/get_rules_configs
     * <p>
     ...
     * See https://authok.com/docs/api/management/v2#!/Rules_Configs/delete_rules_configs_by_key
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Rules_Configs/put_rules_configs_by_key
     *
     * @param rulesConfigKey the rules config key
