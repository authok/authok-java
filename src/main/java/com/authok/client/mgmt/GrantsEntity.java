...
import com.authok.client.mgmt.filter.GrantsFilter;
import com.authok.json.mgmt.Grant;
import com.authok.json.mgmt.GrantsPage;
...
/**
 * Class that provides an implementation of the Grants methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Grants/
 * <p>
...
public class GrantsEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/Grants/get_grants
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Grants/delete_grants_by_id<br>
     *
