...
import com.authok.json.mgmt.logstreams.LogStream;
...
/**
 * Class that provides an implementation of the Log Streams methods of the Management API as defined in https://authok.cn/docs/api/management/v1#!/Log_Streams
 * <p>
...
public class LogStreamsEntity extends BaseManagementEntity {
     ...
     * See the <a href="https://authok.cn/docs/api/management/v1#!/Log_Streams/get_log_streams">API Documentation for more information.</a>
     *
     ...
     * See the <a href="https://authok.cn/docs/api/management/v1#!/Log_Streams/get_log_streams_by_id">API Documentation for more information.</a>
     *
     ...
     * See the <a href="https://authok.cn/docs/api/management/v1#!/Log_Streams/post_log_streams">API Documentation for more information.</a>
     *
     ...
     * See the <a href="https://authok.cn/docs/api/management/v1#!/Log_Streams/patch_log_streams_by_id">API Documentation for more information.</a>
     *
     ...
     * See the <a href="https://authok.cn/docs/api/management/v1#!/Log_Streams/delete_log_streams_by_id">API Documentation for more information.</a>
     *
