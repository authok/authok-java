...
/**
 * Class that provides an implementation of the User Blocks methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/User_Blocks
 * <p>
...
public class UserBlocksEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/User_Blocks/get_user_blocks
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/User_Blocks/delete_user_blocks
     *
     * @param identifier the identifier. Either a username, phone_number, or email.
     * @return a Request to execute.
     */
     ...
     * See https://authok.com/docs/api/management/v2#!/User_Blocks/get_user_blocks_by_id
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/User_Blocks/delete_user_blocks_by_id
     *
     * @param userId the user id.
     * @return a Request to execute.
     */
