...
import com.authok.json.mgmt.guardian.*;
...
/**
 * Class that provides an implementation of the Guardian methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Guardian
 * <p>
...
public class GuardianEntity extends BaseManagementEntity {
     ...
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/post_ticket">Management API2 docs</a>
     */
     ...
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/delete_enrollments_by_id">Management API2 docs</a>
     */
     ...
     *
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/get_templates">Management API2 docs</a>
     */
     ...
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/put_templates">Management API2 docs</a>
     */
     ...
     *
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/get_factors">Management API2 docs</a>
     */
     ...
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/put_factors_by_name">Management API2 docs</a>
     */
     ...
     *
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/get_twilio">Management API2 docs</a>
     */
     ...
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/put_twilio">Management API2 docs</a>
     */
     ...
     *
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/get_sns">Management API2 docs</a>
     */
     ...
     * @param provider the provider data to set.
     * @return a Request to execute.
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/put_sns">Management API2 docs</a>
     */
     ...
     *
     * @return a Request to execute
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/get_policies">Management API2 docs</a>
     */
     ...
     *
     * @return a Request to execute
     * @see <a href="https://authok.com/docs/api/management/v2#!/Guardian/put_policies">Management API2 docs</a>
     */
