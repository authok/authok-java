...
/**
 * Class that provides an implementation of the Events methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Logs
 * <p>
...
public class LogEventsEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/Logs/get_logs
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Logs/get_logs_by_id
     *
