...
import com.authok.client.mgmt.filter.ActionsFilter;
import com.authok.client.mgmt.filter.BaseFilter;
import com.authok.client.mgmt.filter.PageFilter;
import com.authok.json.mgmt.actions.*;
import com.authok.json.mgmt.actions.Action;
import com.authok.json.mgmt.actions.ActionsPage;
import com.authok.json.mgmt.actions.BindingsPage;
import com.authok.json.mgmt.actions.BindingsUpdateRequest;
import com.authok.json.mgmt.actions.Execution;
import com.authok.json.mgmt.actions.Triggers;
import com.authok.json.mgmt.actions.Version;
import com.authok.json.mgmt.actions.VersionsPage;
...
/**
 * Class that provides an implementation of the Actions methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Actions
 *
 * <p>
...
public class ActionsEntity extends BaseManagementEntity {
     ...
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/post_action">https://authok.com/docs/api/management/v2#!/Actions/post_action</a>
     */
     ...
     * @return a Request to execute
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/get_action">https://authok.com/docs/api/management/v2#!/Actions/get_action</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/delete_action">https://authok.com/docs/api/management/v2#!/Actions/delete_action</a>
     */
     ...
     * @return a request to execute.
     *
     * <a href="https://authok.com/docs/api/management/v2#!/Actions/get_triggers">https://authok.com/docs/api/management/v2#!/Actions/get_triggers</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/patch_action">https://authok.com/docs/api/management/v2#!/Actions/patch_action</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/post_deploy_action">https://authok.com/docs/api/management/v2#!/Actions/post_deploy_action</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/get_action_version">https://authok.com/docs/api/management/v2#!/Actions/get_action_version</a>
     */
     ...
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/post_deploy_draft_version">https://authok.com/docs/api/management/v2#!/Actions/post_deploy_draft_version</a>
     */
     ...
     * @return a request to be executed.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/get_execution">https://authok.com/docs/api/management/v2#!/Actions/get_execution</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/get_actions">https://authok.com/docs/api/management/v2#!/Actions/get_actions</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/get_action_versions">https://authok.com/docs/api/management/v2#!/Actions/get_action_versions</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/get_bindings">https://authok.com/docs/api/management/v2#!/Actions/get_bindings</a>
     */
     ...
     * @return a request to execute.
     *
     * @see <a href="https://authok.com/docs/api/management/v2#!/Actions/patch_bindings">https://authok.com/docs/api/management/v2#!/Actions/patch_bindings</a>
     */
    ...
    private static class EmptyObjectRequest<T> extends EmptyBodyRequest<T> {
        ...
        protected RequestBody createRequestBody() {
            ...
            // https://github.com/authok/authok-java/issues/324
