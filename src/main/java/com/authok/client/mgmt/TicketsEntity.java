...
/**
 * Class that provides an implementation of the Tickets methods of the Management API as defined in https://authok.cn/docs/api/management/v1#!/Tickets
 * <p>
...
public class TicketsEntity extends BaseManagementEntity {
     ...
     * See https://authok.cn/docs/api/management/v1#!/Tickets/post_email_verification
     *
     ...
     * See https://authok.cn/docs/api/management/v1#!/Tickets/post_password_change
     *
