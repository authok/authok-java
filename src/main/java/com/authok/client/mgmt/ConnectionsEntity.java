...
/**
 * Class that provides an implementation of the Connections methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Connections
 * <p>
...
public class ConnectionsEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/Connections/get_connections
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Connections/get_connections_by_id
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Connections/post_connections
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Connections/delete_connections_by_id
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Connections/patch_connections_by_id
     *
     * @param connectionId the connection id.
     ...
     * See https://authok.com/docs/api/management/v2#!/Connections/delete_users_by_email
     *
