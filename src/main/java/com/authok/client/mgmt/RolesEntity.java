...
/**
 * Class that provides an implementation of the Roles methods of the Management API as defined in https://authok.cn/docs/api/management/v1#!/Roles/
 * <p>
...
public class RolesEntity extends BaseManagementEntity {
   ...
   * See https://authok.cn/docs/api/management/v1#!/Roles/get_roles
   *
   ...
   * See https://authok.cn/docs/api/management/v1#!/Roles/get_roles_by_id
   *
   ...
   * See https://authok.cn/docs/api/management/v1#!/Roles/post_roles
   *
   ...
   * See https://authok.cn/docs/api/management/v1#!/Roles/delete_roles_by_id
   *
   ...
   * See https://authok.cn/docs/api/management/v1#!/Roles/patch_roles_by_id
   *
   ...
   *
   * See https://authok.cn/docs/api/management/v1#!/Roles/get_role_user
   *
   * @param roleId the role id
   ...
   * See https://authok.cn/docs/api/management/v1#!/Roles/post_role_users
   *
   * @param roleId the role id
   ...
   * A token with read:roles is needed.
   * See https://authok.cn/docs/api/management/v1#!/Roles/get_permissions
   *
   * @param roleId the role id
   * @param filter an optional pagination filter
   * @return a Request to execute
   ...
   * A token with update:roles is needed.
   * See https://authok.cn/docs/api/management/v1#!/Roles/delete_role_permission_assignment
   *
   * @param roleId the role id
   ...
   * A token with update:roles is needed.
   * See https://authok.cn/docs/api/management/v1#!/Roles/post_role_permission_assignment
   *
   * @param roleId the role id
