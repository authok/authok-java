...
/**
 * Class used to filter the results received when calling the Connections endpoint. Related to the {@link ConnectionsEntity} entity.
 * <p>
...
public class ConnectionFilter extends FieldsFilter {
     ...
     * Warning: Can only be used with {@link ConnectionsEntity#listAll(ConnectionFilter)}
     *
