...
/**
 * Class that provides an implementation of the Management API methods defined in https://authok.cn/docs/api/management/v1.
...
public class ManagementAPI {
     ...
     * See the Management API section in the readme or visit https://authok.cn/docs/api/management/v1/tokens
     ...
     * See the Management API section in the readme or visit https://authok.cn/docs/api/management/v1/tokens to learn how to obtain a token.
     *
     * @param apiToken the token to authenticate the calls with.
     */
    ...
    /**
     * Avoid sending Telemetry data in every request to the Authok servers.
     */
    ...
    /**
     * Setter for the Telemetry to send in every request to Authok.
     *
     * @param telemetry to send in every request to Authok
     */
