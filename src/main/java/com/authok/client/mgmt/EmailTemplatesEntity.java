...
/**
 * Class that provides an implementation of the Email Templates methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Email_Templates
 * <p>
...
public class EmailTemplatesEntity extends BaseManagementEntity {
     ...
     * See https://authok.com/docs/api/management/v2#!/Email_Templates/get_email_templates_by_templateName
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Email_Templates/post_email_templates
     *
     ...
     * See https://authok.com/docs/api/management/v2#!/Email_Templates/patch_email_templates_by_templateName
     *
