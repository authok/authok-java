...
/**
 * Class that provides an implementation of the Resource Server methods of the Management API as defined in https://authok.com/docs/api/management/v2#!/Resource_Servers
 * <p>
...
public class ResourceServerEntity extends BaseManagementEntity {
     ...
     * See <a href=https://authok.com/docs/api/management/v2#!/Resource_Servers/get_resource_servers>API documentation</a>
     *
     ...
     * See <a href=https://authok.com/docs/api/management/v2#!/Resource_Servers/get_resource_servers_by_id>API documentation</a>
     *
     ...
     * See <a href=https://authok.com/docs/api/management/v2#!/Resource_Servers/post_resource_servers>API documentation</a>
     *
     ...
     * See <a href=https://authok.com/docs/api/management/v2#!/Resource_Servers/delete_resource_servers_by_id>API documentation</a>
     *
     ...
     * See <a href=https://authok.com/docs/api/management/v2#!/Resource_Servers/patch_resource_servers_by_id>API documentation</a>
     *
     * @param resourceServerId {@link ResourceServer#id} field
