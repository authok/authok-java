...
public class ConnectionTest extends JsonTest<Connection> {
    ...
    public void shouldSerialize() throws Exception {
        Connection connection = new Connection("my-connection", "authok");
        ...
        MatcherAssert.assertThat(serialized, JsonMatcher.hasEntry("name", "my-connection"));
        assertThat(serialized, JsonMatcher.hasEntry("display_name", "COOL!"));
        assertThat(serialized, JsonMatcher.hasEntry("strategy", "authok"));
    ...
    public void shouldDeserialize() throws Exception {
        ...
        assertThat(connection.getStrategy(), is("authok"));
