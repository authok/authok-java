...
public class ActionsPageTest extends JsonTest<ActionsPage> {
    ...
    public void shouldDeserialize() throws Exception {
        ...
        MatcherAssert.assertThat(page.getItems().get(0), is(instanceOf(Action.class)));
        MatcherAssert.assertThat(page.getItems().get(1), is(instanceOf(Action.class)));
        MatcherAssert.assertThat(page.getTotal(), is(4));
    }
    ...
    public void shouldCreatePageFromList() {
        ...
        assertThat(page, is(notNullValue()));
        MatcherAssert.assertThat(page.getItems(), hasSize(1));
    }
    ...
    public void shouldCreatePageWithAllParams() {
        ...
        MatcherAssert.assertThat(page.getLength(), is(1));
        MatcherAssert.assertThat(page.getTotal(), is(2));
        MatcherAssert.assertThat(page.getLimit(), is(3));
        MatcherAssert.assertThat(page.getNext(), is("next"));
    }
}
