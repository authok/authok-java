...
public class TenantTest extends JsonTest<Tenant> {
    ...
    private static final String json = "{\"change_password\":{},\"guardian_mfa_page\":{},\"default_audience\":\"https://domain.authok.com/myapi\",\"default_directory\":\"Username-Password-Authentication\",\"error_page\":{},\"flags\":{},\"friendly_name\":\"My-Tenant\",\"picture_url\":\"https://pic.to/123\",\"support_email\":\"support@authok.com\",\"support_url\":\"https://support.authok.com\",\"allowed_logout_urls\":[\"https://domain.authok.com/logout\"], \"session_lifetime\":24}";
    ...
    public void shouldSerialize() throws Exception {
        ...
        tenant.setDefaultAudience("https://domain.authok.com/myapi");
        ...
        tenant.setSupportEmail("support@authok.com");
        tenant.setSupportUrl("https://support.authok.com");
        tenant.setAllowedLogoutUrls(Collections.singletonList("https://domain.authok.com/logout"));
        ...
        assertThat(serialized, JsonMatcher.hasEntry("default_audience", "https://domain.authok.com/myapi"));
        ...
        assertThat(serialized, JsonMatcher.hasEntry("support_email", "support@authok.com"));
        assertThat(serialized, JsonMatcher.hasEntry("support_url", "https://support.authok.com"));
        assertThat(serialized, JsonMatcher.hasEntry("allowed_logout_urls", Arrays.asList("https://domain.authok.com/logout")));
    ...
    public void shouldDeserialize() throws Exception {
        ...
        assertThat(tenant.getDefaultAudience(), is("https://domain.authok.com/myapi"));
        ...
        assertThat(tenant.getSupportEmail(), is("support@authok.com"));
        assertThat(tenant.getSupportUrl(), is("https://support.authok.com"));
        assertThat(tenant.getAllowedLogoutUrls(), contains("https://domain.authok.com/logout"));
