...
public class RolesEntityTest extends BaseMgmtEntityTest {
  ...
  public void shouldListRolesWithoutFilter() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/roles"));
  ...
  public void shouldGetRole() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/roles/1"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldCreateRole() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/roles"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldUpdateRole() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("PATCH", "/api/v1/roles/1"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldDeleteRole() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("DELETE", "/api/v1/roles/1"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  }
  ...
  public void shouldListUsersWithoutFilter() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/roles/1/users"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldListUsersWithTotals() throws Exception {
    ...
    public void shouldListUsersWithCheckpointPaging() throws Exception {
        ...
        assertThat(response, is(notNullValue()));
        MatcherAssert.assertThat(response.getItems(), hasSize(2));
        MatcherAssert.assertThat(response.getNext(), is("MjAyMS0wMy0yOSAxNjo1MDo09s44NDYxODcrMDAsb3JnX2Y0VXZUbG1iSWd2005zTGw"));
        MatcherAssert.assertThat(response.getStart(), is(nullValue()));
        MatcherAssert.assertThat(response.getLength(), is(nullValue()));
        MatcherAssert.assertThat(response.getTotal(), is(nullValue()));
        MatcherAssert.assertThat(response.getLimit(), is(nullValue()));
    }
  ...
  public void shouldAssignUsers() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/roles/1/users"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldListPermissionsWithoutFilter() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/roles/1/permissions"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldAddPermissions() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/roles/1/permissions"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
  ...
  public void shouldRemovePermissions() throws Exception {
    ...
    assertThat(recordedRequest, hasMethodAndPath("DELETE", "/api/v1/roles/1/permissions"));
    assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
    assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
