...
import com.authok.net.multipart.FilePart;
import com.authok.net.multipart.KeyValuePart;
import com.authok.net.multipart.RecordedMultipartRequest;
...
public class JobsEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldGetJob() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/jobs/1"));
    ...
    public void shouldGetJobErrorDetails() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/jobs/1/errors"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldRequestUsersExport() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/jobs/users-exports"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldSendUserAVerificationEmailWithNullClientIdAndEmailVerification() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/jobs/verification-email"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldRequestUsersImport() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/jobs/users-imports"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
