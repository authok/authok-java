...
import com.authok.json.mgmt.actions.BindingActionReference;
import com.authok.json.mgmt.actions.BindingUpdate;
import com.authok.json.mgmt.actions.BindingsPage;
import com.authok.json.mgmt.actions.BindingsUpdateRequest;
import com.authok.json.mgmt.actions.Dependency;
import com.authok.json.mgmt.actions.Execution;
import com.authok.json.mgmt.actions.Secret;
import com.authok.json.mgmt.actions.Trigger;
...
import static com.authok.client.MockServer.readFromRequest;
...
public class ActionsEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldGetAction() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/actions/actions/action-id"));
    ...
    public void shouldCreateAction() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/actions/actions"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldDeleteAction() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("DELETE", "/api/v1/actions/actions/action-id"));
    ...
    public void shouldGetActionTriggers() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/actions/triggers"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldUpdateAction() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("PATCH", "/api/v1/actions/actions/action-id"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldDeployAction() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/actions/actions/action-id/deploy"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldGetActionVersion() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/actions/actions/action-id/versions/version-id"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldRollBackActionVersion() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/actions/actions/action-id/versions/version-id/deploy"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
        assertThat(recordedRequest.getBody(), is(notNullValue()));
    ...
    public void shouldGetExecution() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/actions/executions/execution-id"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldListActionsWithNoFilter() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/actions/actions"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldUpdateTriggerBinding() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("PATCH", "/api/v1/actions/triggers/trigger-id/bindings"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
