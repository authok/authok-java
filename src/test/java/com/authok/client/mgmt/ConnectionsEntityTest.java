...
import com.authok.client.mgmt.filter.ConnectionFilter;
import com.authok.json.mgmt.Connection;
import com.authok.json.mgmt.ConnectionsPage;
...
public class ConnectionsEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldListConnections() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/connections"));
    ...
    public void shouldListConnectionsWithStrategy() throws Exception {
        ConnectionFilter filter = new ConnectionFilter().withStrategy("authok");
        ...
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
        assertThat(recordedRequest, hasQueryParameter("strategy", "authok"));
    ...
    public void shouldGetConnection() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("GET", "/api/v1/connections/1"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldCreateConnection() throws Exception {
        Request<Connection> request = api.connections().create(new Connection("my-connection", "authok"));
        assertThat(request, is(notNullValue()));
        ...
        assertThat(recordedRequest, hasMethodAndPath("POST", "/api/v1/connections"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
        ...
        assertThat(body, hasEntry("strategy", "authok"));
    ...
    public void shouldDeleteConnection() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("DELETE", "/api/v1/connections/1"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    }
    ...
    public void shouldThrowOnUpdateConnectionWithNullId() {
        exception.expect(IllegalArgumentException.class);
        exception.expectMessage("'connection id' cannot be null!");
        api.connections().update(null, new Connection("my-connection", "authok"));
    }
    ...
    public void shouldUpdateConnection() throws Exception {
        Request<Connection> request = api.connections().update("1", new Connection("my-connection", "authok"));
        assertThat(request, is(notNullValue()));
        ...
        assertThat(recordedRequest, hasMethodAndPath("PATCH", "/api/v1/connections/1"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldDeleteConnectionUser() throws Exception {
        ...
        assertThat(recordedRequest, hasMethodAndPath("DELETE", "/api/v1/connections/1/users"));
        assertThat(recordedRequest, hasHeader("Content-Type", "application/json"));
        assertThat(recordedRequest, hasHeader("Authorization", "Bearer apiToken"));
