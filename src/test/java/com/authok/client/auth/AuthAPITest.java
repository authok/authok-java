...
import com.authok.net.AuthRequest;
...
import static com.authok.client.UrlMatcher.hasQueryParameter;
import static com.authok.client.UrlMatcher.isUrl;
...
public class AuthAPITest {
    ...
    public void shouldCreateUserInfoRequest() throws Exception {
        com.authok.net.Request<UserInfo> request = api.userInfo("accessToken");
        ...
        assertThat(response.getValues(), hasEntry("user_id", "authok|58454..."));
        ...
        assertThat(response.getValues(), hasEntry("sub", "authok|58454..."));
    ...
    public void shouldCreateStartEmailPasswordlessFlowRequest() throws Exception {
        com.authok.net.Request<PasswordlessEmailResponse> request = api.startPasswordlessEmailFlow("user@domain.com",
    ...
    public void startPasswordlessEmailFlowShouldThrowWhenEmailIsNull() {
        exception.expect(IllegalArgumentException.class);
        exception.expectMessage("'email' cannot be null!");
        com.authok.net.Request<PasswordlessEmailResponse> request = api.startPasswordlessEmailFlow(null, PasswordlessEmailType.CODE);
    }
    ...
    public void startPasswordlessEmailFlowShouldThrowWhenTypeIsNull() {
        ...
        com.authok.net.Request<PasswordlessEmailResponse> request = api.startPasswordlessEmailFlow("user@domain.com", null);
    }
    ...
    public void shouldCreateStartSmsPasswordlessFlowRequest() throws Exception {
        com.authok.net.Request<PasswordlessSmsResponse> request = api.startPasswordlessSmsFlow("+16511234567");
        assertThat(request, is(notNullValue()));
    ...
    public void shouldCreateRevokeTokenRequest() throws Exception {
        com.authok.net.Request<Void> request = api.revokeToken("2679NfkaBn62e6w5E8zNEzjr");
        assertThat(request, is(notNullValue()));
